    ...
    <section className="relative min-h-screen flex items-center justify-center bg-[#050505] px-6 py-24 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="font-['Cormorant_Garamond'] text-xl md:text-2xl leading-relaxed text-rose-50/80 space-y-8">
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              ...
              viewport={{ once: true }}
            >
              There are thoughts I’ve carried quietly — about what I understood too late,
              what I wish I had said differently, and what{" "}
              <span className="text-white italic">still feels unfinished</span> in my heart.
            </motion.p>
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-rose-100/60 font-light"
            >
